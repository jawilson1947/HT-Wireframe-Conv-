...
//getuserratings.php
ChromePhp::warn('GetUserRatings.php');
$user_name = 'root';
  ...
  if($db_found)  {
      ...
      $sql = "select * from ht.tblUserRating where UserID = ".$pkg->id;
      ChromePhp::warn($sql);
      ...
      if($result) {
        ...
        ChromePhp::warn("Total Ratings for ".$pkg->firstname.": ".$userratingcount);
        if($userratingcount >1 ) {
          ChromePhp::warn($userratingcount.' User Ratings found');       
           } else {

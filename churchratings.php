        ...
        if(empty($defaultRatings)) {
               ...
               if ($ratingcount < 1 ) {
                    ...
                    foreach($events as $value) {
                    	$sql = "insert into ht.tblEventRatings(ChurchID,EventID,Category,rank,DontTallyIfZero,datecreated) 
                    	        select ".$value->ChurchID.",".$value->EventID.", Category, rank,DontTallyIfZero,now() from ht.tblDefaultRatings";
                    	        ChromePhp::warn($sql);
